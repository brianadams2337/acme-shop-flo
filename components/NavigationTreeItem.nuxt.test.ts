...
describe('disabled Link', () => {
  it('should render a <div> tag for disabled link', async () => {
    const { getByText } = await renderSuspended(NavigationTreeItem, {
      props: {
  ...
  it('should not emit `mouseenter:navigation-item` event', async () => {
    const { getByText, emitted } = await renderSuspended(NavigationTreeItem, {
      props: {
        navigationItem: navigationItemExternalFactory.build({
          name: 'Item',
          customData: {
...
describe('active Link', () => {
  ...
  it('should emit `mouseenter:navigation-item` event', async () => {
    const { getByRole, emitted } = await renderSuspended(NavigationTreeItem, {
      props: {
        navigationItem: navigationItemExternalFactory.build({
          name: 'Item',
        }),
