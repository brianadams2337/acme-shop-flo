...
describe('ProductPrice.vue', () => {
  describe('lowest Prior Price', () => {
    it('should not render lowest prior price if its not present', async () => {
      ...
      const { queryByTestId } = await renderSuspended(ProductPrice, {
        props: { price },
      })
    ...
    it('should show prior price', async () => {
      ...
      const { getByTestId } = await renderSuspended(ProductPrice, {
        props: {
          price,
  ...
  describe('reductions', () => {
    it('should show a absolute reduction', async () => {
      ...
      const { getByText, getByTestId } = await renderSuspended(ProductPrice, {
        props: { price },
      })
    ...
    it('should hide badges', async () => {
      ...
      const { getByTestId, queryByText } = await renderSuspended(ProductPrice, {
    ...
    it('should apply promotion color', async () => {
      ...
      const { getByTestId, getByText } = await renderSuspended(ProductPrice, {
    ...
    it('should multiple reductions', async () => {
      ...
      const { getAllByText, getByTestId, getAllByTestId } =
        await renderSuspended(ProductPrice, {
          props: { price },
        })
