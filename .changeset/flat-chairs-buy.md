...
Replaced `SFProductCardImageSliderButton` and `SFButton` usages with the new shared `SFSliderArrowButton` component for consistent arrow button design across the Storefront application.
