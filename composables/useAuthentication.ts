...
export const useAuthentication = async (event: any) =>
  ...
  // ) =>
  {
    ...
    const handleError = (_error: unknown) => {
      // TODO: Handle error for the ofetch
      ...
      // log if error is not present in httpErrorMessages
