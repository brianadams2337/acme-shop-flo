<template>
  <button
    class="flex items-center justify-center p-2 text-gray-400 transition-transform duration-300 focus-within:shadow-secondary hover:text-gray-900 focus-visible:shadow-outer-solid disabled:hover:translate-x-0 disabled:hover:text-gray-400"
    :class="{
