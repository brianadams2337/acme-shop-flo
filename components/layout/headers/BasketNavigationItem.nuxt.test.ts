...
it('should render BasketNavigationItem with empty basket', async () => {
...
it.each([1, 2])(
  'should render basket BasketNavigationItem with %i basket item and logged out user',
  async (itemCount) => {
    useBasket.mockReturnValue({
      count: ref(itemCount),
      status: ref('success'),
...
it.each([1, 2])(
  'should render basket BasketNavigationItem with %i basket item and logged in user',
  async (itemCount) => {
    useBasket.mockReturnValue({
      count: ref(itemCount),
      status: ref('success'),
